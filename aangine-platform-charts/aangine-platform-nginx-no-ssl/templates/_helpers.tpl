...
*/}}
{{- define "aangine-platform-nginx-nossl.name" -}}
...
*/}}
{{- define "aangine-platform-nginx-nossl.fullname" -}}
  {{- $name := required "applicationName is required" .Values.services.nginx.applicationName -}}
  {{- if contains $name $.Release.Name -}}
    {{- printf "%s-no-ssl" $.Release.Name | trunc 63 | trimSuffix "-" -}}
  {{- else -}}
    {{- printf "%s-%s-no-ssl" $.Release.Name $name | trunc 63 | trimSuffix "-" -}}
  {{- end -}}
{{- end -}}
...
*/}}
{{- define "aangine-platform-nginx-nossl.domainName" -}}
...
*/}}
{{- define "aangine-platform-nginx-nossl.chart" -}}
...
Common labels
*/}}
{{- define "aangine-platform-nginx-nossl.labels" -}}
helm.sh/chart: {{ include "aangine-platform-nginx-nossl.chart" . }}
{{ include "aangine-platform-nginx-nossl.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "aangine-platform-nginx-nossl.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aangine-platform-nginx-nossl.name" . }}
{{- if $.Release.Name }}
...
*/}}
{{- define "aangine-platform-nginx-nossl.serviceAccountName" -}}
